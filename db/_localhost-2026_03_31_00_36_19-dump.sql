...
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='病害详情表';
...
INSERT INTO `defect_detail` VALUES (67,23,'Medium_Cracking',0.45378378033638,'2026-03-26 14:43:09',NULL,NULL,NULL),(68,23,'High_Cracking',0.32610416412353516,'2026-03-26 14:43:09',NULL,NULL,NULL),(69,23,'High_Cracking',0.2640770375728607,'2026-03-26 14:43:09',NULL,NULL,NULL),(70,24,'Medium_Cracking',0.45378378033638,'2026-03-26 14:47:47',NULL,NULL,NULL),(71,24,'High_Cracking',0.32610416412353516,'2026-03-26 14:47:47',NULL,NULL,NULL),(72,24,'High_Cracking',0.2640770375728607,'2026-03-26 14:47:47',NULL,NULL,NULL),(73,25,'Medium_Cracking',0.45378378033638,'2026-03-26 14:48:35',NULL,NULL,NULL),(74,25,'High_Cracking',0.32610416412353516,'2026-03-26 14:48:35',NULL,NULL,NULL),(75,25,'High_Cracking',0.2640770375728607,'2026-03-26 14:48:35',NULL,NULL,NULL);
...
CREATE TABLE `defect_entity` (
  ...
  `defect_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '病害类型',
  `lng` double NOT NULL COMMENT '经度(聚合后的中心点)',
  `lat` double NOT NULL COMMENT '纬度(聚合后的中心点)',
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'ACTIVE' COMMENT '状态: 待维修/已修复',
...
INSERT INTO `defect_entity` VALUES (1,'Medium_Cracking',114.5,114.6,'ACTIVE','2026-03-31 00:27:28','2026-03-31 00:27:27'),(2,'High_Cracking',114.5,114.6,'ACTIVE','2026-03-31 00:27:28','2026-03-31 00:27:27'),(3,'High_Cracking',114.5,114.6,'ACTIVE','2026-03-31 00:27:28','2026-03-31 00:27:27'),(4,'Medium_Cracking',114.7,114.8,'ACTIVE','2026-03-31 00:28:13','2026-03-31 00:28:13'),(5,'High_Cracking',114.7,114.8,'ACTIVE','2026-03-31 00:28:13','2026-03-31 00:28:13'),(6,'High_Cracking',114.7,114.8,'ACTIVE','2026-03-31 00:28:13','2026-03-31 00:28:13'),(7,'Medium_Cracking',35.681236,139.767125,'ACTIVE','2026-03-31 00:30:28','2026-03-31 00:30:27'),(8,'High_Cracking',35.681236,139.767125,'ACTIVE','2026-03-31 00:30:28','2026-03-31 00:30:27'),(9,'High_Cracking',35.681236,139.767125,'ACTIVE','2026-03-31 00:30:28','2026-03-31 00:30:27');
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='无人机抓拍记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `inspection_image` VALUES (23,10,1,'origin/2026-03-26/338a7f81.jpg','result/2026-03-26/fc4833db.jpg',114514,114514,114514,114514,1,3,'2026-03-26 14:43:08','2026-03-26 14:43:08','DONE',NULL),(24,10,1,'origin/2026-03-26/e45e498d.jpg','result/2026-03-26/a00cb736.jpg',114514,114514,114514,114514,1,3,'2026-03-26 14:47:47','2026-03-26 14:47:46','DONE',NULL),(25,10,1,'origin/2026-03-26/bbc08f3b.jpg','result/2026-03-26/591c3b76.jpg',114514,114514,114514,114514,1,3,'2026-03-26 14:48:34','2026-03-26 14:48:34','DONE',NULL);
...
INSERT INTO `inspection_task` VALUES (10,'南校区主干道AI巡检测试',1,NULL,0,'2026-03-05 00:51:29','2026-03-26 14:48:35',9),(11,'string',1,'[{\"lag\": 114514.0, \"lng\": 114514.0}]',2,'2026-03-25 23:26:30','2026-03-25 23:26:30',0);
...
-- Dump completed on 2026-03-31  0:36:19
